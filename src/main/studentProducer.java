...
public static String generateNames(){
  ...
  /*  static String name;
    ...
    static String[] Names={"Ali","Veli","Halil","Can","Ayþe","Mehmet",         //30
            "Cem","Sena","Mert","Yusuf","Melisa"," Zeynep","Hasan",
            "Berke","Yasin","Murat","Hasan","Mert","Ahmet","Tugba",
            "Gizem","Ozlem","Fatih","Ramiz","Ezel","Utku","Omer",
            "Eyþan","Aslý","Osman"};

    static String[] Surnames={"Ozturk","Ganiz","Bayraktar","Yilmaz","Taþ","Kerim",     //20
    ...
    public static void generateName(){
            int i;
            i=(int)(1+Math.random()*30);
            name = Names[i];

    }
    public static void generateSurname(){
        int j;
        j=(int)(1+Math.random()*20);
        surname = Surnames[j];
    }
